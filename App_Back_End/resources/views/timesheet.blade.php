...
<body class="bg-deeppurple">
    <div class="flex">
        ...
        <div class="flex-1 p-16 h-screen overflow-y-auto">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    {{ optional(\Carbon\Carbon::parse($shift->pivot->actual_start))->format('H:i') ?? '-' }} -
                                    {{ optional(\Carbon\Carbon::parse($shift->pivot->actual_end))->format('H:i') ?? '-' }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full
            @if($shift->pivot->submitted_at) bg-green-100 text-green-800
            @else bg-yellow-100 text-yellow-800 @endif">
                                        {{ $shift->pivot->submitted_at ? 'Ingediend' : 'Openstaand' }}
                                    </span>
                                </td>
                            </tr>
                            @endforeach
